                                ...
                                @foreach($enrollments as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ url('/enrollments/' . $item->id . '/edit') }}" title="Edit course"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
